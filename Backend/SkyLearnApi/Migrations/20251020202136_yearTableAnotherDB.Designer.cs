...
namespace SkyLearnApi.Migrations
{
    ...
    [Migration("20251020202136_yearTableAnotherDB")]
    partial class yearTableAnotherDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SkyLearnApi.Entities.ApplicationUser", b =>
                {
                    ...
                    b.ToTable("Users", null, t =>
                        {
                            t.HasCheckConstraint("CK_User_FullName_MinWords", "LEN(FullName) - LEN(REPLACE(FullName, ' ', '')) + 1 >= 3");
                        });
                });
