        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false, defaultValue: "First Middle Last"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_FullName_MinWords", "FullName = '' OR LEN(FullName) - LEN(REPLACE(FullName, ' ', '')) + 1 >= 3");
                });
