  ...
  return (
    <div className="page-container">
      ...
      <div className="content-container">
        ...
        {/*dah llrabt beno w el parti*/ }
         <div className="sub-nav">
          <Link to="/culture" className="sub-nav-link active-sub-nav-link"> Course</Link>
          <Link to="/culture/participants" className="sub-nav-link">Participants</Link>
          <Link to="/culture/grades" className="sub-nav-link">Grades</Link>
        ...
        {activePage === 'Participants' && ( <div className="participants-section">
