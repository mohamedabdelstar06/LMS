...
//   final int courseId;
//
//   const UpdateNewCoursePage({super.key, required this.courseModel, required this.courseId});
//
//   @override
...
//
//   void _initControllers(GetCourseModel course) {
...
//         ),
//         child: Center(
//           child: BlocConsumer<GetCoursseCubit, GetCourseState>(
...
//                   orElse: () => GetCourseModel(
//                     id: widget.courseId,
//                     title: '',
//                     description: '',
//                     creditHours: 0,
//                     departmentName: '',
//                     yearName: '', departmentId: 0, yearId: 0, enrolledStudentsCount: 0, imageUrl: '', instructorId: 0, instructorName: '', createdAt: DateTime.now(),
//                   ),
//                 );
//
//                 _initControllers(course);
//                 return _buildFormContainer(state);
//               }
...
//
//
//   Widget _buildFormContainer(GetCourseState state) {
...
//   }
//
//   Widget _buildActionButtons(GetCourseState state) {
...
//                       }
//
//                       context.read<GetCoursseCubit>().updateCourse(
//
//
//                         widget.courseId,
//
