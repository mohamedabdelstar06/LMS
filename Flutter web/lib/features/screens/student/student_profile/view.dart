...
class _ProfileScreenState extends State<StudentProfileScreen> {
  ...
  void _initControllers(User user) {
    ...
    departmentController.text = user.academicInfo.department.name ;
    squadronController.text = user.academicInfo.squadron.name ;
    yearLevelController.text = user.academicInfo.year.name.toString() ;
  ...
  String getFullImageUrl(String? imageUrl) {
    ...
    final cleanUrl = imageUrl.startsWith('/')
        ...
        : imageUrl;
    return 'https://skylearn.runasp.net/$cleanUrl';
  }
