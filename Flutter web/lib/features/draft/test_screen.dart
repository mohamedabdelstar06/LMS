...
class _ImportStudentsScreenState extends State<ImportStudentsScreen> {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (state is ImportStudentsLoading)
                    _buildLoadingCard()
                  else if (state is ImportStudentsSuccess)
                    _buildResultsCard(state.response),
                ],
              ),
            );
          },
  ...
  Widget _buildUploadCard(BuildContext context, ImportStudentsState state) {
    return Container(
            ...
            child: Row(
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () {
                      context.read<ImportStudentsCubit>().resetState();
                      setState(() {
                        selectedFileName = null;
                        selectedFileBytes = null;
                      });
